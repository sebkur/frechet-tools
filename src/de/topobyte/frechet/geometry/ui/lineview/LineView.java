...
package de.topobyte.frechet.geometry.ui.lineview;

import geo.draw.IdentityCoordinateTransformer;
import geometry.transformation.GeometryTransformator;
...
public class LineView extends JPanel implements EpsilonSettable {
	...
	public LineView(int epsilon, Editable line1, Editable line2,
	...
	private void draw(Graphics2D g, Editable editable, String name,
