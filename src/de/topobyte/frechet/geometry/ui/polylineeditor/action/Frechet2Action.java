...
import de.topobyte.frechet.geometry.ui.polylineeditor.FrechetDialog2;

public class Frechet2Action extends BasicAction
{

	private final Content content;

	public Frechet2Action(Content content)
	{
		super("frechet 2", "show frechet diagram", null);
