...
package de.topobyte.frechet.geometry.ui.frechet.lines;
...
import de.topobyte.frechet.geometry.ui.frechet.EpsilonSettable;
import de.topobyte.frechet.geometry.ui.frechet.calc.LineSegment;
import de.topobyte.frechet.geometry.ui.frechet.segment.SegmentPane;
...
public class FrechetDiagram extends JPanel implements EpsilonSettable
{
	...
	public FrechetDiagram(int epsilon, Editable line1, Editable line2)
	{
	...
	private void setup()
	{
		...
		int nSegmentsP = line1.getNumberOfCoordinates() - 1;
		int nSegmentsQ = line2.getNumberOfCoordinates() - 1;
	...
	private LineSegment getSegment(Editable line, int n)
	{
